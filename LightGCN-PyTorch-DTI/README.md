...
We provide three processed datasets: Gowalla, Yelp2018 and Amazon-book and one small dataset LastFM and DTI.

see more in `dataloader.py`

## An example to run a 3-layer LightGCN

run LightGCN on **DTI** dataset:

* command

` cd code && python main.py --decay=1e-4 --lr=0.0005 --layer=3 --seed=2020 --dataset="dti" --topks="[20]" --recdim=64`
